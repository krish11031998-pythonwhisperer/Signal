...
public class ProgressBar: UIView {
	...
	public init(bgColor: UIColor = .gray.withAlphaComponent(0.35), borderColor: UIColor = .white.withAlphaComponent(0.7), fillColor: UIColor = .white) {
	...
	public func animateProgress(progress: CGFloat = 0.5) {
